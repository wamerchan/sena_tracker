...
<aside id="sidebar"
    ...
    <div class="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-sena via-emerald-400 to-sena-dark rounded-r"></div>

    <!-- Logo -->
    <div class="h-20 flex items-center justify-center border-b border-gray-100 dark:border-gray-700 mx-5 relative">
        <div class="flex flex-col items-center">
            <div class="flex items-center gap-2">
                <div class="w-9 h-9 rounded-lg bg-gradient-to-br from-sena to-emerald-400 flex items-center justify-center shadow-sm">
            ...
            <span class="text-[10px] text-gray-400 dark:text-gray-500 font-semibold tracking-widest uppercase mt-0.5">Administrador de Evidencias</span>
        </div>
    </div>

    <!-- Navigation -->
    <nav class="mt-5 px-3 space-y-1 flex-1">
        <span class="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest px-3 mb-2 block">Menu Principal</span>
        <?php
        ...
        foreach ($menuItems as $item):
            ...
            <a href="?view=<?= $item['view'] ?>"
                ...
                <?php if ($active): ?>
                    <div class="absolute left-0 top-1/4 bottom-1/4 w-[3px] rounded-r-full bg-gradient-to-b from-sena to-emerald-400"></div>
                <?php endif; ?>
                <div class="w-8 h-8 rounded-lg flex items-center justify-center transition-all duration-200 <?= $activeIconBg ?>">
    ...
    <div class="px-3 pb-5 space-y-2">
        ...
        <button id="theme-toggle"
            ...
            <i class="fa-solid fa-sun hidden dark:inline text-yellow-400 group-hover:scale-110 transition-transform"></i>
...
<div id="sidebar-overlay" class="fixed inset-0 bg-black/50 z-40 hidden md:hidden transition-opacity backdrop-blur-sm"></div>
